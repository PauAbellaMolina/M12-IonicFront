        ...
        <ion-grid style="margin: 0; width: 100%;">
            ...
            <ion-row style="display: flex;" class="ion-justify-content-center">
                <div class="pointsButtonInfo">
                    <ion-button v-if="recompense.used == true" class="useRecompense" style="--backgound: #464646;" disabled>Ja utilitzada</ion-button>
                    <ion-button v-if="recompense.used == false" @click="useRecompense()" class="useRecompense" style="--backgound: #464646;">{{ showHide }} QR</ion-button>
